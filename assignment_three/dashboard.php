...
$base_url = $server_name . $script_dir;

$base_url = preg_replace('#/dashboard\.php$#', '', $base_url);
$id = $_SESSION['id'];

$feedback = new AnonymousFeedback(new FileStorage());
$feedbacks = $feedback->getFeedbacks($id);
    ...
    <div class="relative flex min-h-screen overflow-hidden bg-gray-50 py-6 sm:py-12">
        ...
        <div class="relative max-w-7xl mx-auto">
            <div class="flex justify-end">
                <span class="block text-gray-600 font-mono border border-gray-400 rounded-xl px-2 py-1">Your feedback form link: <strong><?php echo $base_url. '/feedback.php?key=' . $_SESSION['id'];?></strong></span>
            </div>
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
                ...
                <div class="relative flex items-center space-x-3 rounded-lg border border-gray-300 bg-white px-6 py-5 shadow-sm focus-within:ring-2 focus-within:ring-indigo-500 focus-within:ring-offset-2 hover:border-gray-400">
                    <div class="focus:outline-none">
                        <p class="text-gray-500"><?=$feedback['message']?></p>
                    </div>
                </div>
                <?php 
                endforeach;
